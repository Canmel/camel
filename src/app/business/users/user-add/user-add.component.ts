...
export class UserAddComponent implements OnInit {
  ...
  constructor(private http: Https, private fb: FormBuilder, private _notification: NzNotificationService, public route: Router) {
  ...
  submit() {
    this.http.postByMap(Urls.USERS.SAVE, this.formData).subscribe(data => {
      const msg = data['msg'];
      const respCode = data['code'];
      if (respCode.valueOf('200')) {
        this._notification.success('成功', msg);
      }
    });
  }
