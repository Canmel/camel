...
(function (c, j) {
  function k(a) {
    return !c(a).parents().addBack().filter(function () {
      return $.curCSS(this, "visibility") === "hidden" || c.expr.filters.hidden(this)
    }).length
  }
    ...
    c.fn.extend({
      _focus: c.fn.focus, focus: function (a, b) {
        ...
        a = c.browser.msie && /(static|relative)/.test(this.css("position")) || /absolute/.test(this.css("position")) ? this.parents().filter(function () {
          var cposition = $(this).css("position");
          var coverflow = $(this).css("overflow");
          var coverflowy = $(this).css("overflow-y");
          var coverflowx = $(this).css("overflow-x");


          return /(relative|absolute|fixed)/.test(cposition) && /(auto|scroll)/.test(coverflow + coverflowy + coverflowx)
...
(function (b, j) {
  ...
  b.Widget.prototype = {
    widgetName: "widget", widgetEventPrefix: "", options: {disabled: false}, _createWidget: function (a, c) {
      ...
      d = d || {};
      if (c.originalEvent && b.event.props) {
        a =
  ...
  d.ui.ddmanager = {
    current: null, droppables: {"default": []}, prepareOffsets: function (a, b) {
      var c = d.ui.ddmanager.droppables[a.options.scope] || [], e = b ? b.type : null,
        g = (a.currentItem || a.element).find(":data(droppable)").addBack(), f = 0;
...
(function (e) {
  e.widget("ui.resizable", e.ui.mouse, {
    ...
    _respectSize: function (b) {
      var a = this.options, c = this.axis, d = l(b.width) && a.maxWidth && a.maxWidth < b.width,
        f = l(b.height) && a.maxHeight && a.maxHeight < b.height, g = l(b.width) && a.minWidth && a.minWidth > b.width,
  ...
  e.ui.plugin.add("resizable", "animate", {
    stop: function (b) {
      var a = e(this).data("resizable"), c = a.options, d = a._proportionallyResizeElements,
        f = d.length && /textarea/i.test(d[0].nodeName), g = f && e.ui.hasScroll(d[0], "left") ? 0 : a.sizeDiff.height;
  ...
  e.ui.plugin.add("resizable", "grid", {
    resize: function () {
      var b = e(this).data("resizable"), a = b.options, c = b.size, d = b.originalSize, f = b.originalPosition,
        g = b.axis;
  ...
  e.widget("ui.selectable", e.ui.mouse, {
    options: {appendTo: "body", autoRefresh: true, distance: 0, filter: "*", tolerance: "touch"}, _create: function () {
      ...
      if (!this.options.disabled) {
        ...
        e(c.target).parents().addBack().each(function () {
          var b = e.data(this, "selectable-item");
          if (b) {
  ...
  d.widget("ui.sortable", d.ui.mouse, {
    ...
    _mouseCapture: function (a, b) {
      ...
      if (this.options.handle && !b) {
        var f = false;
        d(this.options.handle, c).find("*").addBack().each(function () {
...
(function (c, j) {
  c.widget("ui.dialog", {
    options: {
      ...
      var a = this, b = a.options, d = b.title || a.originalTitle || "&#160;", f = c.ui.dialog.getTitleId(a.element),
...
(function (d) {
  d.widget("ui.slider", d.ui.mouse, {
    ...
    _refreshValue: function () {
      var a =
          this.options.range, b = this.options, c = this, e = !this._animateOff ? b.animate : false, f, h = {}, g, i, j,
        l;
  ...
  d.widget("ui.tabs", {
    options: {
      ...
      this.anchors.bind(c.event + ".tabs",
        function () {
          var g = this, f = d(g).closest("li"), j = b.panels.filter(":not(.ui-tabs-hide)"),
  ...
  d.extend(L.prototype, {
    ...
    _checkOffset: function (a, b, c) {
      var e = a.dpDiv.outerWidth(), f = a.dpDiv.outerHeight(), h = a.input ? a.input.outerWidth() : 0,
        i = a.input ? a.input.outerHeight() : 0, g = document.documentElement.clientWidth + d(document).scrollLeft(),
    ...
    _determineDate: function (a, b, c) {
      var e = function (h) {
        ...
        var g = (h.toLowerCase().match(/^c/) ? d.datepicker._getDate(a) : null) || new Date, k = g.getFullYear(),
          l = g.getMonth();
        g = g.getDate();
    ...
    _generateHTML: function (a) {
      ...
      var s = this._get(a, "dayNamesMin"), z = this._get(a, "monthNames"), v = this._get(a, "monthNamesShort"),
        p = this._get(a, "beforeShowDay"), w = this._get(a, "showOtherMonths"), H = this._get(a, "selectOtherMonths");
  ...
  e.effects.bounce = function (b) {
    return this.queue(function () {
      var a = e(this), l = ["position", "top", "left"], h = e.effects.setMode(a, b.options.mode || "effect"),
        d = b.options.direction || "up", c = b.options.distance || 20, m = b.options.times || 5, i = b.duration || 250;
...
(function (c) {
  c.effects.drop = function (d) {
    return this.queue(function () {
      var a = c(this), h = ["position", "top", "left", "opacity"], e = c.effects.setMode(a, d.options.mode || "hide"),
...
(function (c) {
  c.effects.puff = function (b) {
    return this.queue(function () {
      var a = c(this), e = c.effects.setMode(a, b.options.mode || "hide"), g = parseInt(b.options.percent, 10) || 150,
        h = g / 100, i = {height: a.height(), width: a.width()};
      c.extend(b.options, {
        fade: true,
        mode: e,
  ...
  c.effects.size = function (b) {
    return this.queue(function () {
      var a = c(this), e = ["position", "top", "left", "width", "height", "overflow", "opacity"],
        g = ["position", "top", "left", "overflow", "opacity"], h = ["width", "height", "overflow"], i = ["fontSize"],
