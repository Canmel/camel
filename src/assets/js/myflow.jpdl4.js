(function ($) {
  ...
  $.extend(true, myflow.config.tools.states, {
    start: {
      ...
      name: {text: '<<start>>'},
      text: {text: '开始'},
      img: {src: 'assets/images/flows/48/start_event_empty.png', width: 48, height: 48},
      ...
      props: {
        ...
        role: {
          name: 'role', label: '角色', value: '', editor: function () {
            return new myflow.editors.selectEditor([{name: '超级管理员', value: 1}, {name: '系统管理员', value: 2}]);
          }
        }
      }
    },
      ...
      name: {text: '<<end>>'},
      text: {text: '结束'},
      img: {src: 'assets/images/flows/48/end_event_terminate.png', width: 48, height: 48},
      attr: {width: 50, heigth: 50},
      props: {
        text: {
          name: 'text', label: '显示', value: '', editor: function () {
    ...
    'end-cancel': {
      ...
      text: {text: '取消'},
      img: {src: 'assets/images/flows/48/end_event_cancel.png', width: 48, height: 48},
      attr: {width: 50, heigth: 50},
      props: {
        text: {
          name: 'text', label: '显示', value: '', editor: function () {
    ...
    'end-error': {
      ...
      name: {text: '<<end-error>>'},
      text: {text: '错误'},
      img: {src: 'assets/images/flows/48/end_event_error.png', width: 48, height: 48},
      attr: {width: 50, heigth: 50},
      props: {
        text: {
          name: 'text', label: '显示', value: '', editor: function () {
    ...
    fork: {
      ...
      name: {text: '<<fork>>'},
      text: {text: '分支'},
      img: {src: 'assets/images/flows/48/gateway_parallel.png', width: 48, height: 48},
      attr: {width: 50, heigth: 50},
      props: {
        text: {
          name: 'text', label: '显示', value: '', editor: function () {
